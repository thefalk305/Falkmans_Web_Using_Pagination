...
**********************************************/
      ...
      // zoom allPoints
      map.fitBounds(L.polyline(allPoints, {smoothFactor: 0.8 // Adjust this value for desired smoothness
}).getBounds());
...
**********************************************/
      ...
      function playAmbientSound(type) {
        ...
        // });
        map.fitBounds(segmentBounds, {animate: true, padding: [20, 20] });
      }
      ...
      function pausePointReached() {
        ...
        map.flyTo(allPoints[currentIndex], 10, {
          animate: true,
          duration: 1.5, easeLinearity: 0.25 // seconds
        });
